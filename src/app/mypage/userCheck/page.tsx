                            ...
                            <form onSubmit={formik.handleSubmit}>
                              <div className="relative mb-6">
                                ...
                                <label
                                  ...
                                  className="absolute left-2 -top-3 text-sm text-gray-500 transition-all peer-placeholder-shown:top-4 peer-placeholder-shown:-mt-1 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:-top-3 peer-focus:text-sm peer-focus:text-blue-600"
                                  htmlFor="password"
                                >
                                  Password
                                </label>
